...
// Traduction française — publiée via `php artisan lang:publish` (Laravel 11+
// ne fournit plus les fichiers de langue par défaut). Bug réel trouvé et
// corrigé (11/09/2026, audit UI/UX) : sans ce fichier, les 5 formulaires
// publics affichaient littéralement "validation.required"/"validation.email"
// au lieu d'un message en français (APP_LOCALE=fr était déjà correct, mais
// sans fichier lang/fr/, Laravel retombe sur la clé brute faute de traduction
// trouvée). Mêmes clés que lang/en/validation.php (Laravel 12), pour rester
// synchronisé si un futur upgrade Laravel ajoute de nouvelles règles.
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné a été trouvé dans une fuite de données. Merci de choisir un autre :attribute.',
    ],
    ...
    // Noms de champs affichés dans les messages ci-dessus (":attribute") —
    // couvre les champs des 5 formulaires publics (contact, annonce,
    // événement, fiche annuaire, actualité, voir §28/§29).
    'attributes' => [
        'name' => 'nom',
        'email' => 'email',
        'phone' => 'téléphone',
        ...
        'website' => 'site web',
        'reservation_url' => 'lien de réservation',
        'excerpt' => 'résumé',
        'body' => 'texte',
