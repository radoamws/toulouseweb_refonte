...
| 8. Cinéma | 🟡 Pages publiques + scraper AlloCiné réécrit (`scrape:cinema`, une source par salle — 24/27 — fiches film + salle + horaires précis, planifié quotidien) ; non re-vérifié en direct (accès réseau bloqué depuis ce sandbox, voir §13) |
